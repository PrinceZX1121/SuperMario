...
public class GameFrame extends JFrame{
	...
	public ImageIcon brickImage = new ImageIcon("image/砖.png");
	public ImageIcon queryImage = new ImageIcon("image/问号.png");
	public ImageIcon floorImage = new ImageIcon("image/地面.png");
...
//		}).start();
	...
	public void paint(Graphics g) {
		...
		big.drawImage(Map.mapImage, bg.x, bg.y, null);
